 ...
 */
 ...
 class  CONNECT_ADMINISTRATOR
   {
 
 
    public $connector = array();
	
	
	 public function __construct()
	 {
 	  $this->connector[0] = "localhost";
	  $this->connector[1] = "root";
          $this->connector[2] = "6983450qaz* *";
          $this->connector[3] = "dolcloud";	  
     	  }
	 ...
	 $this->connector[0] = null;
         ...
         $this->connector[2] = null;
         $this->connector[3] = null;
          }
